...
if __name__ == "__main__":
    ...
    DATASETS = ['credit']  # Có thể thêm nhiều dataset hơn nếu muốn
    ...
    if not results:
        ...
        #  - Sử dụng paired t-test và Cohen's d (effect size)
        # ------------------------------------------------------------
        try:
            ...
            if rows_stat:
                ...
                stat_df["t-statistic"] = stat_df["t-statistic"].map(lambda v: _fmt_num_local(v, 3))
